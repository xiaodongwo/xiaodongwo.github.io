...
$$\begin{align*}  
\mathbf{x}\_{t} &= \sqrt{1 - \beta_t} x_{t-1} + \sqrt{\beta_t} v_t \\  
...
$$ 
\begin{align*} 
\mathbf{x}_{t} &= \sqrt{1 - \beta_t} \mathbf{x}_{t-1} + \sqrt{\beta_t} \mathbf{v}_t \\ 
