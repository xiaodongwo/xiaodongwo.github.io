...
&= \sqrt{\alpha_t}\big(\sqrt{\alpha_{t-1}}\,\mathbf{x}_{t-2} + \sqrt{1-\alpha_{t-1}}\,\boldsymbol{\epsilon}_{t-2}\big)
...
&= \sqrt{\alpha_t\alpha_{t-1}}\,\mathbf{x}_{t-2}
   ...
   + \sqrt{1-\alpha_t}\,\boldsymbol{\epsilon}_{t-1} \\
&= \boxed{\sqrt{\alpha_t\alpha_{t-1}\cdots\alpha_1}\,\mathbf{x}_0}_{\text{1}}
  + \boxed{\sqrt{1-\alpha_t}\,\boldsymbol{\epsilon}_{t-1} + \sqrt{\alpha_t(1-\alpha_{t-1})}\,\boldsymbol{\epsilon}_{t-2} + \cdots
    + \sqrt{\alpha_t\cdots\alpha_2(1-\alpha_1)}\,\boldsymbol{\epsilon}_0}_{\text{2}}
\end{align*}
$$
