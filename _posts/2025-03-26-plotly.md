...
$$q({x}\_t \| {x}_{t-1}) = \mathcal{N}\left({x}_t; \mu_t, \Sigma_t\right) = \mathcal{N}\left({x}_t; \sqrt{1 - \beta\_t} {x}\_{t-1}, \beta_t \mathbf{I}\right)$$
...
$$
\begin{align*}  
\mathbf{x}\_{t} &= \sqrt{1 - \beta_t} \mathbf{x}\_{t-1} + \sqrt{\beta_t} \mathbf{v}\_t \\ &=\sqrt{\alpha_t} \mathbf{x}\_{t-1} + \sqrt{1-\alpha_t} \boldsymbol{\epsilon}\_{t-1} \\  
